...
function [output] = func_VIR_IRheader_Level1B(output_file_path, samples, lines, bands, spectral_resolution)
...
fid = fopen([output_file_path '.QUB.HDR'],'wt');    % Open in text write mode
